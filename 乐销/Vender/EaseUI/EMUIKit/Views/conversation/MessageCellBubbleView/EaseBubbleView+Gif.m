...
- (void)_setupImageBubbleMarginConstraintsInGif
{
...
- (void)_setupImageBubbleConstraintsInGif
{
    [self _setupImageBubbleMarginConstraintsInGif];
}
...
- (void)setupGifBubbleView
{
    ...
    [self _setupImageBubbleConstraintsInGif];
